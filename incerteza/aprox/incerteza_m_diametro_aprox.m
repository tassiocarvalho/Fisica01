...
% Implementando funções de arredondamento em linha sem função local
...
% Aplicando regras de arredondamento diretamente ao invés de usar uma função local
